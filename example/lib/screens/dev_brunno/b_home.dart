    ...
    return  Scaffold(
      ...
      drawer: FluentLeftNav(
          ...
          body: Column( children: [
            FluentListItemOneLine(text: "Tagged", leading: Icon(Icons.sticky_note_2_outlined),),
            FluentListItemOneLine(text: "Starred", leading: Icon(Icons.star_border_outlined),),
            FluentListItemOneLine(text: "Liked", leading: Icon(Icons.thumb_up_alt_outlined),),
            FluentListItemOneLine(text: "Reposted", leading: Icon(Icons.copy),),
            FluentListItemOneLine(text: "Watched", leading: Icon(Icons.remove_red_eye_outlined),),
            FluentListItemOneLine(text: "Uploads", leading: Icon(Icons.view_agenda_outlined),),
